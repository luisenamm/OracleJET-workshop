...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'ojs': path.resolve(__dirname, './web/js/libs/oj/v10.0.1/debug'),
      'ojtranslations': path.resolve(__dirname, './web/js/libs/oj/v10.0.1/resources'),
    ...
    new WebpackRequireFixupPlugin(
      {
        ...
        baseResourceUrl: "./web/js/libs/oj/v10.0.1"
      }
    )
