// Copyright (c) 2014, 2021, Oracle and/or its affiliates.  Licensed under The Universal Permissive License (UPL), Version 1.0 as shown at https://oss.oracle.com/licenses/upl/
...
@include module-include-once("common.helper") {
  ...
  $themeRootMap: map-merge($themeRootMap, (jetReleaseVersion: "v10.0.1"));
